...
if(isset($_GET['id'])){
  ...
  //for related car
  $cat_id = $car['cat_id'];
  $sqlRel = "SELECT * FROM `cars` WHERE cat_id = ? AND `published` = 1 AND id != ?";
  $stmtRel = $conn->prepare($sqlRel);

  $stmtRel->execute([$cat_id, $id]);

  $relatedCars = $stmtRel->fetchAll();
//   dd($relatedCars);
}
        ...
        <div class="container pt-5">
            ...
            <div class="row">
                <div class="col-lg-8 mb-5">
                    <h1 class="display-4 text-uppercase mb-5"><?php echo $car['title'];?></h1>
                    <div class="row mx-n2 mb-3">
                        <div class="col-md-3 col-6 px-2 pb-2">
                            <img class="img-fluid w-100" src="img/<?php echo $car['image'];?>" alt="">
                        </div>
                        
                    </div>
                    <p><?php echo $car['content'];?></p>
                    <div class="row pt-2">
                        <div class="col-md-3 col-6 mb-2">
                            <i class="fa fa-car text-primary mr-2"></i>
                            <span>Model: <?php echo $car['model'];?></span>
                        </div>
                        <div class="col-md-3 col-6 mb-2">
    ...
    <div class="container-fluid pb-5">
        <div class="container pb-5">
            ...
            ?>
                ...
                <div class="rent-item">
                    <img class="img-fluid mb-4"  src="img/<?php echo $car['image'];?>" alt="">
                    ...
                    <a class="btn btn-primary px-3" href=""><?php echo $car['price'];?></a>
                </div>
