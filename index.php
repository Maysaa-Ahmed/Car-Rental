            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        ...
                        <a class="btn btn-primary px-3" href="detail.php?id=<?php  echo $car['id']; ?>"><?php echo $car['price'];?>$</a>
        ...
        <div class="container py-5">
            ...
            <div class="owl-carousel testimonial-carousel">
                ...
                <div class="testimonial-item d-flex flex-column justify-content-center px-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <img class="img-fluid ml-n4"  src="img/<?php echo $testimonial['image'];?>" alt="">
                        <h1 class="display-2 text-white m-0 fa fa-quote-right"></h1>
                    </div>
                    <h4 class="text-uppercase mb-2"><?php echo $testimonial['name'];?></h4>
                    <i class="mb-2"><?php echo $testimonial['position'];?></i>
                    <p class="m-0"><?php echo $testimonial['content'];?></p>
                </div>
                <?php
                    }
                ?>
